class Disciplina {
    ...
    constructor(nome: string) { //Os parametros informados não são os atributos definidos lá em cima, será somente depois de "conecta-los" na chave.
...
let materia: Disciplina = new Disciplina('Matemática');
